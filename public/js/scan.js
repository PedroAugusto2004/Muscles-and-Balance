...
function displayNutritionFacts(product) {
    ...
    const calories = foodNutrients.find(n => n.nutrientName === "Energy")?.value || 'N/A';
    const protein = foodNutrients.find(n => n.nutrientName === "Protein")?.value || 'N/A';
    const fat = foodNutrients.find(n => n.nutrientName === "Total lipid (fat)")?.value || 'N/A';
    const carbs = foodNutrients.find(n => n.nutrientName === "Carbohydrate, by difference")?.value || 'N/A';
    const fiber = foodNutrients.find(n => n.nutrientName === "Fiber, total dietary")?.value || 'N/A';
    const sodium = foodNutrients.find(n => n.nutrientName === "Sodium, Na")?.value || 'N/A';
